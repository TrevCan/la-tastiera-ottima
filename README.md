# Realtime typewriter to keyboard

### DESCRIPTION

Performs Optical Character Recognition (OCR) on typewriter fonts. 
Not for several words, but for **only one character at a time**.

My goal for this project is to be able to use my real typewriter
as a keyboard on my computer.

If you are looking for OCR for printed documents and non-monospaced
fonts, this is not the project for you. Although you could just train
an AI model with enough training data with the font of your choice.

This uses [LPBeaulieu's](https://github.com/LPBeaulieu) 
[Typewriter-OCR-TintypeText](https://github.com/LPBeaulieu/Typewriter-OCR-TintypeText) 
project, as it was very useful for generating an AI model capable of
recognition. He also has a very good dataset.
